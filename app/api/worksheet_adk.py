...
from app.agents.worksheet_agent_adk import WorksheetAgentADK
...
async def generate_worksheet(
    ...
    """
    Generate a worksheet based on uploaded textbook image files (jpg, jpeg, png, etc.) using the ADK-based agent.
    """
    try:
        pil_images = []
        ...
        # Call the async generate_worksheet method
        result = await worksheet_agent.generate_worksheet(
            images=pil_images,
